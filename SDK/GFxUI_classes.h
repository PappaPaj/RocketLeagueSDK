...
public:
	...
	unsigned char                                      UnknownData3GTM[0x4];                                      // 0x0074(0x0004) MISSED OFFSET
...
public:
	...
	unsigned char                                      bFakeMobileTouches : 1;                                    // 0x00D8(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataDZL1[0x2];                                      // 0x00D8(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
public:
	unsigned char                                      bUsesFontlib : 1;                                          // 0x00A0(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataOR79[0x2];                                      // 0x00A0(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSetSRGBOnImportedTextures : 1;                            // 0x00A0(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataUEWN[0x2];                                      // 0x00A4(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPackTextures : 1;                                         // 0x00A0(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDM7H[0x2];                                      // 0x00A4(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceSquarePacking : 1;                                   // 0x00A0(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0HMC[0x2];                                      // 0x00A4(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataN01U[0x4];                                      // 0x00A4(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData4MGC[0x3];                                      // 0x00BD(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownDataTF9U[0x4];                                      // 0x00E4(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData41U2[0x8];                                      // 0x0110(0x0008) UNKNOWN PROPERTY: QWordProperty GFxUI.SwfMovie.ImportTimeStamp
...
public:
	...
	unsigned char                                      bUnload : 1;                                               // 0x0168(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData6WST[0x2];                                      // 0x0168(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
// 0x001A (FullSize[0x0178] - InheritedSize[0x015E])
...
// 0x002A (FullSize[0x0188] - InheritedSize[0x015E])
...
// 0x0040 (FullSize[0x019E] - InheritedSize[0x015E])
...
public:
	...
	unsigned char                                      bTakeFocus : 1;                                            // 0x0178(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData7N52[0x2];                                      // 0x0178(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCaptureInput : 1;                                         // 0x0178(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataLFOI[0x2];                                      // 0x017C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bStartPaused : 1;                                          // 0x0178(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDAOW[0x2];                                      // 0x017C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableGammaCorrection : 1;                                // 0x0178(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataOY0W[0x2];                                      // 0x017C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisplayWithHudOff : 1;                                    // 0x0178(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData08P0[0x2];                                      // 0x017C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EGFxRenderTextureMode>                 RenderTextureMode;                                         // 0x017C(0x0001) (Edit)
	unsigned char                                      UnknownDataE0X8[0x3];                                      // 0x017D(0x0003) MISSED OFFSET
...
// 0x002C (FullSize[0x01A0] - InheritedSize[0x0174])
class UGFxEvent_FSCommand : public USequenceEvent
{
public:
	unsigned char                                      UnknownDataDZ8G[0x4];                                      // 0x017C(0x0004) MISSED OFFSET
...
public:
	...
	unsigned char                                      UnknownDataQBWM[0xC];                                      // 0x00A0(0x000C) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownDataJUZO[0x50];                                     // 0x0078(0x0050) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUClasses
	unsigned char                                      UnknownData39BE[0x50];                                     // 0x00C8(0x0050) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.ASUObjects
	int                                                NextASUObject;                                             // 0x0118(0x0004) (Const, Transient)
	unsigned char                                      UnknownDataEPWW[0x4];                                      // 0x011C(0x0004) MISSED OFFSET
	class USwfMovie*                                   MovieInfo;                                                 // 0x0120(0x0008)
	unsigned char                                      bMovieIsOpen : 1;                                          // 0x0128(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownData4Q9N[0x2];                                      // 0x0128(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisplayWithHudOff : 1;                                    // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownData706B[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableGammaCorrection : 1;                                // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataL5QO[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bWidgetsInitializedThisFrame : 1;                          // 0x0128(0x0001) BIT_FIELD (Const, Transient)
	unsigned char                                      UnknownDataFCSM[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bLogUnhandedWidgetInitializations : 1;                     // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2FLD[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowInput : 1;                                           // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataY333[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowFocus : 1;                                           // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataBM05[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAutoPlay : 1;                                             // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataLC8D[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPauseGameWhileActive : 1;                                 // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataTMZO[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisableWorldRendering : 1;                                // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2G4F[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCaptureWorldRendering : 1;                                // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataZQHN[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCloseOnLevelChange : 1;                                   // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataDKJ0[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOnlyOwnerFocusable : 1;                                   // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataQYM8[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceFullViewport : 1;                                    // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataES7A[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDiscardNonOwnerInput : 1;                                 // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataXGLV[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCaptureInput : 1;                                         // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9B0J[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCaptureMouseInput : 1;                                    // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataNEUV[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIgnoreMouseInput : 1;                                     // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVPZ0[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsSplitscreenLayoutModified : 1;                          // 0x0128(0x0001) BIT_FIELD (Transient)
	unsigned char                                      UnknownData099A[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShowHardwareMouseCursor : 1;                              // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownData5JFX[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceFullScreen : 1;                                      // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataOQNM[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bBlurLesserMovies : 1;                                     // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataEZPH[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHideLesserMovies : 1;                                     // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataQVR9[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsPriorityBlurred : 1;                                    // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataXET7[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsPriorityHidden : 1;                                     // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataN4NY[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIgnoreVisibilityEffect : 1;                               // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataN80C[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIgnoreBlurEffect : 1;                                     // 0x0128(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataA0RX[0x2];                                      // 0x012C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataA9LW[0x4];                                      // 0x012C(0x0004) MISSED OFFSET
	class UTextureRenderTarget2D*                      RenderTexture;                                             // 0x0130(0x0008) (Edit)
	int                                                LocalPlayerOwnerIndex;                                     // 0x0138(0x0004) (Transient)
	unsigned char                                      UnknownDataWCR9[0x4];                                      // 0x013C(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownDataMA6Z[0x5];                                      // 0x018B(0x0005) MISSED OFFSET
	TArray<struct FGFxWidgetBinding>                   WidgetBindings;                                            // 0x0190(0x0010) (NeedCtorLink)
	unsigned char                                      UnknownDataJTFJ[0x50];                                     // 0x01A0(0x0050) UNKNOWN PROPERTY: MapProperty GFxUI.GFxMoviePlayer.WidgetPathBindings
	class UGFxObject*                                  SplitscreenLayoutObject;                                   // 0x01F0(0x0008) (Transient)
	int                                                SplitscreenLayoutYAdjust;                                  // 0x01F8(0x0004) (Config)
	unsigned char                                      UnknownData1F9W[0x4];                                      // 0x01FC(0x0004) MISSED OFFSET
	struct FScriptDelegate                             __OnPostAdvance__Delegate;                                 // 0x0200(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownDataPSMU[0xC];                                      // 0x01FC(0x000C) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
