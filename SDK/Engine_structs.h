...
{
	unsigned char                                      bLooping : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataAZI9[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAutoCompleteNode
{
	...
	unsigned char                                      UnknownDataZLZU[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FPlatformInterfaceData
{
	...
	unsigned char                                      UnknownData2HTP[0x3];                                      // 0x0009(0x0003) MISSED OFFSET
	int                                                IntValue;                                                  // 0x000C(0x0004)
	float                                              FloatValue;                                                // 0x0010(0x0004)
	unsigned char                                      UnknownData4JIF[0x4];                                      // 0x0014(0x0004) MISSED OFFSET
...
struct FRigidBodyContactInfo
{
	...
	unsigned char                                      UnknownDataRFS1[0x4];                                      // 0x0034(0x0004) MISSED OFFSET
...
struct FSeqOpInputLink
{
	...
	unsigned char                                      bHasImpulse : 1;                                           // 0x0010(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataB141[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                QueuedActivations;                                         // 0x0014(0x0004)
	unsigned char                                      UnknownDataVELE : 32;                                      // 0x0018(0x0001)
	unsigned char                                      bDisabled : 1;                                             // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataIJVL[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisabledPIE : 1;                                          // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataKZAK[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataF0XM[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
	class USequenceOp*                                 LinkedOp;                                                  // 0x0020(0x0008)
	int                                                DrawY;                                                     // 0x0028(0x0004)
	unsigned char                                      UnknownData4BYF : 32;                                      // 0x002C(0x0001)
	unsigned char                                      bHidden : 1;                                               // 0x002C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataBY3Y[0x2];                                      // 0x002C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              ActivateDelay;                                             // 0x0030(0x0004)
	unsigned char                                      UnknownData0XM5 : 32;                                      // 0x0034(0x0001)
	unsigned char                                      bMoving : 1;                                               // 0x0034(0x0001) BIT_FIELD (Transient, EditorOnly)
	unsigned char                                      UnknownDataUT9Y[0x2];                                      // 0x0034(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMax : 1;                                           // 0x0034(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataU3JS[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMin : 1;                                           // 0x0034(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataVIF9[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bSuccessful : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataKOPD[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataV6X6[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FWorldFractureSettings
{
	...
	unsigned char                                      bEnableChanceOfPhysicsChunkOverride : 1;                   // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataQFCU[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bLimitExplosionChunkSize : 1;                              // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataQ7VW[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              MaxExplosionChunkSize;                                     // 0x0008(0x0004)
	unsigned char                                      UnknownData082X : 32;                                      // 0x000C(0x0001)
	unsigned char                                      bLimitDamageChunkSize : 1;                                 // 0x000C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6AFV[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FParticleRandomSeedInfo
{
	...
	unsigned char                                      bGetSeedFromInstance : 1;                                  // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataID7T[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bInstanceSeedIsIndex : 1;                                  // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNF0V[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bResetSeedOnEmitterLooping : 1;                            // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData6Y5W[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataIZD3[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
struct FSeqOpOutputLink
{
	...
	unsigned char                                      bHasImpulse : 1;                                           // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownData0NL5[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisabled : 1;                                             // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataMF4C[0x2];                                      // 0x0024(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisabledPIE : 1;                                          // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataZ8TV[0x2];                                      // 0x0024(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData3Q2I[0x4];                                      // 0x0024(0x0004) MISSED OFFSET
	class USequenceOp*                                 LinkedOp;                                                  // 0x0028(0x0008)
	float                                              ActivateDelay;                                             // 0x0030(0x0004)
	int                                                DrawY;                                                     // 0x0034(0x0004)
	unsigned char                                      UnknownData9PZ6 : 32;                                      // 0x0038(0x0001)
	unsigned char                                      bHidden : 1;                                               // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataRQ1R[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bMoving : 1;                                               // 0x0038(0x0001) BIT_FIELD (Transient, EditorOnly)
	unsigned char                                      UnknownDataI13M[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMax : 1;                                           // 0x0038(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataL7C0[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMin : 1;                                           // 0x0038(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataUZQN[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                OverrideDelta;                                             // 0x003C(0x0004) (EditorOnly)
	float                                              PIEActivationTime;                                         // 0x0040(0x0004) (Transient, EditorOnly)
	unsigned char                                      UnknownDataD6WQ : 32;                                      // 0x0044(0x0001)
	unsigned char                                      bIsActivated : 1;                                          // 0x0044(0x0001) BIT_FIELD (Transient, NoImport, NonTransactional, EditorOnly)
	unsigned char                                      UnknownData3V4P[0x2];                                      // 0x0044(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSeqVarLink
{
	...
	unsigned char                                      bWriteable : 1;                                            // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataUMC7[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSequenceNeverReadsOnlyWritesToThisVar : 1;                // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataYHB5[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bModifiesLinkedObject : 1;                                 // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataF9JO[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHidden : 1;                                               // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataX6G0[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData1C74 : 32;                                      // 0x0050(0x0001)
	unsigned char                                      bAllowAnyType : 1;                                         // 0x0050(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataO5CA[0x2];                                      // 0x0050(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bMoving : 1;                                               // 0x0050(0x0001) BIT_FIELD (Transient, EditorOnly)
	unsigned char                                      UnknownDataN83F[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMax : 1;                                           // 0x0050(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataQLYL[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMin : 1;                                           // 0x0050(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataRVHU[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bInitialized : 1;                                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9389[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      BSP : 1;                                                   // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataGIFJ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Static : 1;                                                // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData97ME[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Dynamic : 1;                                               // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData3L9H[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      CompositeDynamic : 1;                                      // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData1CLN[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Skybox : 1;                                                // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataEF8M[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Unnamed_2 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataH380[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Unnamed_3 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData56B3[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Unnamed_4 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData9BX7[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Unnamed_5 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8MMK[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Unnamed_6 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataGEE4[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Unnamed_7 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8A14[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_2 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataO9F7[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_3 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDH8R[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_4 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData3IAD[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_5 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataRB51[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_6 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0IGE[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_7 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8NFD[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_8 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataYE15[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_9 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataEGLF[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_10 : 1;                                          // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataKHSR[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cinematic_11 : 1;                                          // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataPKR1[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Gameplay_2 : 1;                                            // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataN4Q7[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Gameplay_3 : 1;                                            // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDBM7[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Gameplay_4 : 1;                                            // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataEAEJ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Gameplay_5 : 1;                                            // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataXWRA[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Crowd : 1;                                                 // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData4CI9[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSeqEventLink
{
	...
	unsigned char                                      bHidden : 1;                                               // 0x002C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataSNLQ[0x2];                                      // 0x002C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bMoving : 1;                                               // 0x002C(0x0001) BIT_FIELD (Transient, EditorOnly)
	unsigned char                                      UnknownData1O0E[0x2];                                      // 0x0030(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMax : 1;                                           // 0x002C(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownData6H9X[0x2];                                      // 0x0030(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bClampedMin : 1;                                           // 0x002C(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownData240E[0x2];                                      // 0x0030(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMusicTrackStruct
{
	...
	unsigned char                                      bAutoPlay : 1;                                             // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataYYSI[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPersistentAcrossLevels : 1;                               // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataCVHV[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataMEUA[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bModify : 1;                                               // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0GND[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bScale : 1;                                                // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataW97M[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bLock : 1;                                                 // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData6LJC[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bIsActive : 1;                                             // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVSTD[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bDisabled : 1;                                             // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2JDJ[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bBlocked : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataM34P[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FKBoxElem
{
	...
	unsigned char                                      bNoRBCollision : 1;                                        // 0x004C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData2ZYV[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPerPolyShape : 1;                                         // 0x004C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataD2WR[0x2];                                      // 0x0050(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FKSphylElem
{
	...
	unsigned char                                      bNoRBCollision : 1;                                        // 0x0048(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataFKVG[0x2];                                      // 0x0048(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPerPolyShape : 1;                                         // 0x0048(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataTL16[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FParticleAttractorCollisionAction
{
	...
	unsigned char                                      UnknownData3M4C[0x7];                                      // 0x0001(0x0007) MISSED OFFSET
...
struct FFireLink
{
	...
	unsigned char                                      bFallbackLink : 1;                                         // 0x0014(0x0001) BIT_FIELD
	unsigned char                                      UnknownData8N8D[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDynamicIndexInited : 1;                                   // 0x0014(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataS43J[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FParticleEvent_GenerateInfo
{
	...
	unsigned char                                      UnknownData9VOI[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
	int                                                Frequency;                                                 // 0x0004(0x0004) (Edit)
	int                                                LowFreq;                                                   // 0x0008(0x0004) (Edit)
	int                                                ParticleFrequency;                                         // 0x000C(0x0004) (Edit)
	unsigned char                                      FirstTimeOnly : 1;                                         // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataIKW0[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      LastTimeOnly : 1;                                          // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataIEV2[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UseReflectedImpactVector : 1;                              // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0PS0[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FName                                       CustomName;                                                // 0x0014(0x0008) (Edit)
	unsigned char                                      UnknownData3Z0G[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
struct FKAggregateGeom
{
	...
	unsigned char                                      bSkipCloseAndParallelChecks : 1;                           // 0x0048(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData2X91[0x2];                                      // 0x0048(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSimpleCollisionPlane : 1;                                 // 0x0048(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0ZFQ[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FGameplayEventsHeader
{
	...
	unsigned char                                      UnknownData7OX8[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
struct FKSphereElem
{
	struct FMatrix                                     TM;                                                        // 0x0000(0x0040) (Edit, EditConst)
	float                                              Radius;                                                    // 0x0040(0x0004) (Edit, EditConst)
	unsigned char                                      bNoRBCollision : 1;                                        // 0x0044(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataC19E[0x2];                                      // 0x0044(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPerPolyShape : 1;                                         // 0x0044(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataS18H[0x2];                                      // 0x0048(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FGameSessionInformation
{
	...
	unsigned char                                      bGameplaySessionInProgress : 1;                            // 0x0030(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataQJ15[0x2];                                      // 0x0030(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataETQL[0x4];                                      // 0x0034(0x0004) MISSED OFFSET
...
struct FTeamInformation
{
	...
	unsigned char                                      UnknownData5E36[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FLUTBlender
{
	...
	unsigned char                                      bHasChanged : 1;                                           // 0x0020(0x0001) BIT_FIELD (Const, Native, Transient)
	unsigned char                                      UnknownData8TD4[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FGameStatGroup
{
	...
	unsigned char                                      UnknownDataQM3M[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bOverride_Mobile_BlurAmount : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGOH5[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_TransitionTime : 1;                       // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataV831[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_Bloom_Scale : 1;                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataN2M4[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_Bloom_Threshold : 1;                      // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataHV20[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_Bloom_Tint : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataL0HC[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_DOF_Distance : 1;                         // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataG1NW[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_DOF_MinRange : 1;                         // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataMD11[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_DOF_MaxRange : 1;                         // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJ9EE[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Mobile_DOF_FarBlurFactor : 1;                    // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataOPO3[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bProcessDuringSpawn : 1;                                   // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataEKZ4[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bProcessDuringUpdate : 1;                                  // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataUGOK[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUseEmitterTime : 1;                                       // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataBUVI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FPolyReference
{
	...
	unsigned char                                      UnknownDataZ6DI[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
struct FNavMeshPathParams
{
	...
	unsigned char                                      bCanMantle : 1;                                            // 0x0008(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataM9QA[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bNeedsMantleValidityTest : 1;                              // 0x0008(0x0001) BIT_FIELD
	unsigned char                                      UnknownData0OYR[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAbleToSearch : 1;                                         // 0x0008(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9MTR[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bOverride_EnableBloom : 1;                                 // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataRXM6[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_EnableDOF : 1;                                   // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataMNA0[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_EnableMotionBlur : 1;                            // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataL1EI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_EnableSceneEffect : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGNHS[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_AllowAmbientOcclusion : 1;                       // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataECXE[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_OverrideRimShaderColor : 1;                      // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataHMAD[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Bloom_Scale : 1;                                 // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData0UJ5[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Bloom_Threshold : 1;                             // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataO2RG[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Bloom_Tint : 1;                                  // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataLLS0[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Bloom_ScreenBlendThreshold : 1;                  // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataRCN0[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Bloom_InterpolationDuration : 1;                 // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataEBPM[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_FalloffExponent : 1;                         // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGQXG[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_BlurKernelSize : 1;                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData95G8[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_BlurBloomKernelSize : 1;                     // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData7RBE[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_MaxNearBlurAmount : 1;                       // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataXJG1[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_MinBlurAmount : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataEELT[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_MaxFarBlurAmount : 1;                        // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJ865[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_FocusType : 1;                               // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData5RBB[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_FocusInnerRadius : 1;                        // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData7X7J[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_FocusDistance : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6C6S[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_FocusPosition : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataWSJ4[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_InterpolationDuration : 1;                   // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJNDI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_DOF_BokehTexture : 1;                            // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6VVA[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MotionBlur_MaxVelocity : 1;                      // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataT2LR[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MotionBlur_Amount : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData4EK9[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MotionBlur_FullMotionBlur : 1;                   // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataR5H9[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MotionBlur_CameraRotationThreshold : 1;          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataL65C[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MotionBlur_CameraTranslationThreshold : 1;       // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataH260[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MotionBlur_InterpolationDuration : 1;            // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataYCVR[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_Desaturation : 1;                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataN3FD[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_Colorize : 1;                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataUZZE[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_TonemapperScale : 1;                       // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataIJNO[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataGE69 : 32;                                      // 0x0004(0x0001)
	unsigned char                                      bOverride_Scene_ImageGrainScale : 1;                       // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownData0T36[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_HighLights : 1;                            // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataH4EA[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_MidTones : 1;                              // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9GXS[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_Shadows : 1;                               // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataPGOW[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_InterpolationDuration : 1;                 // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataH1L2[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_Scene_ColorGradingLUT : 1;                       // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataEOSP[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_RimShader_Color : 1;                             // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataZGLJ[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_RimShader_InterpolationDuration : 1;             // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownData7FN2[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverride_MobileColorGrading : 1;                          // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGTAI[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableBloom : 1;                                          // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataFH66[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableDOF : 1;                                            // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataKXSB[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableMotionBlur : 1;                                     // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataV499[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableSceneEffect : 1;                                    // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataZJ19[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowAmbientOcclusion : 1;                                // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataHA2V[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideRimShaderColor : 1;                               // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData4E2A[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData35M5[0x3];                                      // 0x0035(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownDataGGR9 : 32;                                      // 0x0060(0x0001)
	unsigned char                                      MotionBlur_FullMotionBlur : 1;                             // 0x0060(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData4OSQ[0x2];                                      // 0x0060(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData6Q34[0x4];                                      // 0x00C4(0x0004) MISSED OFFSET
...
struct FEmitterDynamicParameter
{
	...
	unsigned char                                      bUseEmitterTime : 1;                                       // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataHMUY[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSpawnTimeOnly : 1;                                        // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNNUF[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EEmitterDynamicParameterValue>         ValueMethod;                                               // 0x000C(0x0001) (Edit)
	unsigned char                                      UnknownData0PNB[0x3];                                      // 0x000D(0x0003) MISSED OFFSET
	unsigned char                                      UnknownDataP6NP : 32;                                      // 0x0010(0x0001)
	unsigned char                                      bScaleVelocityByParamValue : 1;                            // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataTYH0[0x2];                                      // 0x000D(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataSD2S[0x4];                                      // 0x0014(0x0004) MISSED OFFSET
...
struct FPlayerInformation
{
	...
	unsigned char                                      bIsBot : 1;                                                // 0x0050(0x0001) BIT_FIELD
	unsigned char                                      UnknownData21E2[0x2];                                      // 0x0050(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FCoverSlot
{
	...
	unsigned char                                      UnknownDataSMZO[0x1];                                      // 0x000F(0x0001) MISSED OFFSET
	...
	unsigned char                                      UnknownDataK72G[0x4];                                      // 0x006C(0x0004) MISSED OFFSET
	...
	unsigned char                                      bLeanLeft : 1;                                             // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataICMD[0x2];                                      // 0x0090(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bLeanRight : 1;                                            // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataI1WO[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceCanPopUp : 1;                                        // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataH1QL[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanPopUp : 1;                                             // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownData8BZM[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanMantle : 1;                                            // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataHH2Q[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanClimbUp : 1;                                           // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataPQFI[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceCanCoverSlip_Left : 1;                               // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataVYWJ[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceCanCoverSlip_Right : 1;                              // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataT4HS[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanCoverSlip_Left : 1;                                    // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataZC33[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanCoverSlip_Right : 1;                                   // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownData72AQ[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanSwatTurn_Left : 1;                                     // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataWBFR[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanSwatTurn_Right : 1;                                    // 0x0090(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataMTOB[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnabled : 1;                                              // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData9G8J[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowPopup : 1;                                           // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData3S6P[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowMantle : 1;                                          // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataV5VM[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowCoverSlip : 1;                                       // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataU71I[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowClimbUp : 1;                                         // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataB5XE[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowSwatTurn : 1;                                        // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataN9SX[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceNoGroundAdjust : 1;                                  // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataQZVU[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPlayerOnly : 1;                                           // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataTE69[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPreferLeanOverPopup : 1;                                  // 0x0090(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataQFSM[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDestructible : 1;                                         // 0x0090(0x0001) BIT_FIELD (Transient)
	unsigned char                                      UnknownData11AG[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSelected : 1;                                             // 0x0090(0x0001) BIT_FIELD (Transient)
	unsigned char                                      UnknownDataGOHB[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bFailedToFindSurface : 1;                                  // 0x0090(0x0001) BIT_FIELD (Edit, Transient, EditConst)
	unsigned char                                      UnknownDataGY5Y[0x2];                                      // 0x0094(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bIsWorldInfo : 1;                                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJ7QQ[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bApplyReverb : 1;                                          // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataPOQK[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EReverbPreset>                         ReverbType;                                                // 0x0004(0x0001) (Edit)
	unsigned char                                      UnknownData5Q88[0x3];                                      // 0x0005(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bUseHardware : 1;                                          // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData1EYI[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bFixedTimeStep : 1;                                        // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataOPO6[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      RigidBody : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataKXYI[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Fluid : 1;                                                 // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataO0T8[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cloth : 1;                                                 // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataYV3V[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      SoftBody : 1;                                              // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8GF0[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FApexModuleDestructibleSettings
{
	...
	unsigned char                                      bOverrideMaxChunkSeparationLOD : 1;                        // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataVZU3[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bDisableLod : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataAWZZ[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataM66L : 32;                                      // 0x0010(0x0001)
	unsigned char                                      bApplyCylindricalPacketCulling : 1;                        // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNODE[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTimerData
{
	unsigned char                                      bLoop : 1;                                                 // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData3V3Z[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPaused : 1;                                               // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData130K[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bStateTimer : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataFYCV[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownDataNR79[0x8];                                      // 0x0000(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.WorldInfo.ScreenMessageString.Key
...
struct FLightmassWorldInfoSettings
{
	...
	unsigned char                                      bEnableAdvancedEnvironmentColor : 1;                       // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0Z6O[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataFPM8 : 32;                                      // 0x003C(0x0001)
	unsigned char                                      bUseAmbientOcclusion : 1;                                  // 0x003C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData7TCD[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableImageReflectionShadowing : 1;                       // 0x003C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataLKAH[0x2];                                      // 0x0040(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataB8XM : 32;                                      // 0x0054(0x0001)
	unsigned char                                      bVisualizeMaterialDiffuse : 1;                             // 0x0054(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData9W1V[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bVisualizeAmbientOcclusion : 1;                            // 0x0054(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataB9A5[0x2];                                      // 0x0058(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCompressShadowmap : 1;                                    // 0x0054(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataM8S7[0x2];                                      // 0x0058(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FHostMigrationState
{
	...
	unsigned char                                      UnknownDataIKP9[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
	float                                              HostMigrationElapsedTime;                                  // 0x0004(0x0004)
	float                                              HostMigrationTravelCountdown;                              // 0x0008(0x0004)
	unsigned char                                      UnknownDataS04X[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
	struct FString                                     HostMigrationTravelURL;                                    // 0x0010(0x0010) (NeedCtorLink)
	unsigned char                                      bHostMigrationEnabled : 1;                                 // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGINC[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bEnabled : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataA354[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bLit : 1;                                                  // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataD4U7[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData8KMG[0x8];                                      // 0x0000(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.GameViewportClient.ShowFlags_Mirror.flags0
	unsigned char                                      UnknownDataOQV8[0x8];                                      // 0x0008(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.GameViewportClient.ShowFlags_Mirror.flags1
...
struct FDebugDisplayProperty
{
	...
	unsigned char                                      bSpecialProperty : 1;                                      // 0x0010(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2NGL[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FPBVariationInfo
{
	...
	unsigned char                                      bMeshOnTopOfFacePoly : 1;                                  // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataQLKP[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      Default : 1;                                               // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData1JDZ[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Nothing : 1;                                               // 0x0000(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataQYVG[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Pawn : 1;                                                  // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData3I1A[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Vehicle : 1;                                               // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataAF1F[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Water : 1;                                                 // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData5FTQ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      GameplayPhysics : 1;                                       // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData2ARZ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      EffectPhysics : 1;                                         // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData1DB0[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Ball : 1;                                                  // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataVWSP[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      VehicleBlocker : 1;                                        // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataYIJV[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      BallBlocker : 1;                                           // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataR880[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Untitled4 : 1;                                             // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataC0KX[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Cloth : 1;                                                 // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData5YEI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      FluidDrain : 1;                                            // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataMRUA[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      SoftBody : 1;                                              // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataXBNX[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      FracturedMeshPart : 1;                                     // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataY5JI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      BlockingVolume : 1;                                        // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataXE2H[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      DeadPawn : 1;                                              // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataMHTV[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Clothing : 1;                                              // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData02CC[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      ClothingCollision : 1;                                     // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataZ4BQ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FPBScopeProcessInfo
{
	...
	unsigned char                                      bGenerateLODPoly : 1;                                      // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataOPX1[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPartOfNonRect : 1;                                        // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData1TFV[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownDataIKFW[0x8];                                      // 0x0000(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.SteamDLCInfo.AppID
...
struct FPBEdgeInfo
{
	...
	unsigned char                                      UnknownData0RDK[0x3];                                      // 0x001D(0x0003) MISSED OFFSET
	int                                                ScopeBIndex;                                               // 0x0020(0x0004)
	TEnumAsByte<EScopeEdge>                            ScopeBEdge;                                                // 0x0024(0x0001)
	unsigned char                                      UnknownDataKHAB[0x3];                                      // 0x0025(0x0003) MISSED OFFSET
...
struct FXboxOneDLCInfo
{
	struct FString                                     Key;                                                       // 0x0000(0x0010) (NeedCtorLink)
	struct FName                                       Value;                                                     // 0x0010(0x0008)
	unsigned char                                      bDiscUnlock : 1;                                           // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData7QFO[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownDataBPPZ[0x8];                                      // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlineArbitrationRegistrant.MachineId
...
{
	struct FScriptDelegate                             Condition;                                                 // 0x0000(0x000C) (Edit, NeedCtorLink)
	unsigned char                                      UnknownDataUC6R[0xC];                                      // 0x0000(0x000C) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FGamepadInfo
{
	...
	unsigned char                                      UnknownDataVJ4O[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
	unsigned char                                      bConnected : 1;                                            // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownData326K[0x2];                                      // 0x0001(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FViewTargetTransitionParams
{
	...
	unsigned char                                      UnknownDataG41N[0x3];                                      // 0x0005(0x0003) MISSED OFFSET
	float                                              BlendExp;                                                  // 0x0008(0x0004) (Edit)
	unsigned char                                      bLockOutgoing : 1;                                         // 0x000C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData1OSA[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FOnlineContent
{
	...
	unsigned char                                      UnknownDataU5ND[0x2];                                      // 0x0002(0x0002) MISSED OFFSET
	unsigned char                                      bIsCorrupt : 1;                                            // 0x0004(0x0001) BIT_FIELD
	unsigned char                                      UnknownData4859[0x2];                                      // 0x0002(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FActorToLookAt
{
	...
	unsigned char                                      CurrentlyBeingLookedAt : 1;                                // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataYGCY[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bAllowAmbientOcclusion : 1;                                // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataFW22[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowDominantWholeSceneDynamicShadows : 1;                // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNVE8[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowMotionBlurSkinning : 1;                              // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData3C0Z[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowTemporalAA : 1;                                      // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData73KR[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAllowLightShafts : 1;                                     // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataVYQS[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBuildingMeshInfo
{
	...
	unsigned char                                      UnknownDataAJXB[0x4];                                      // 0x0014(0x0004) MISSED OFFSET
	...
	unsigned char                                      bMeshScaleTranslation : 1;                                 // 0x0028(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataSIDL[0x2];                                      // 0x0028(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideMeshLightMapRes : 1;                              // 0x0028(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataN0VH[0x2];                                      // 0x002C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FRBSplitInfo
{
	unsigned char                                      bFixSize : 1;                                              // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataO7U8[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bUseTwoSidedLighting : 1;                                  // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData0WY4[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShadowIndirectOnly : 1;                                   // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataIJQJ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUseEmissiveForStaticLighting : 1;                         // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8C8H[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FIniLocFileEntry
{
	...
	unsigned char                                      bIsUnicode : 1;                                            // 0x0030(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataNQWU[0x2];                                      // 0x0030(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBankLoadState
{
	...
	unsigned char                                      UnknownDataPS4P[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
...
struct FTouchTracker
{
	...
	unsigned char                                      UnknownData2XYS[0x3];                                      // 0x0011(0x0003) MISSED OFFSET
	unsigned char                                      bTrapInput : 1;                                            // 0x0014(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataTRFW[0x2];                                      // 0x0011(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownDataMAE7[0x8];                                      // 0x0000(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.UniqueLobbyId.Uid
...
struct FKeyBind
{
	...
	unsigned char                                      Control : 1;                                               // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6SGL[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Shift : 1;                                                 // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData28A6[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Alt : 1;                                                   // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataUCP7[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIgnoreCtrl : 1;                                           // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataAPBE[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIgnoreShift : 1;                                          // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData8ZVU[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIgnoreAlt : 1;                                            // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2ZI9[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FLobbyFilter
{
	...
	unsigned char                                      UnknownDataYMOW[0x3];                                      // 0x0021(0x0003) MISSED OFFSET
	unsigned char                                      bNumeric : 1;                                              // 0x0024(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataA1VZ[0x2];                                      // 0x0021(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bInProgress : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataCUTX[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataEY4P[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FSettingsData
{
	...
	unsigned char                                      UnknownData80XX[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
...
struct FSettingsProperty
{
	...
	unsigned char                                      UnknownDataZX9X[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FStatColorMapping
{
	...
	unsigned char                                      DisableBlend : 1;                                          // 0x0020(0x0001) BIT_FIELD (Config, GlobalConfig)
	unsigned char                                      UnknownData1EUD[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSettingsPropertyPropertyMetaData
{
	...
	unsigned char                                      UnknownDataYZYB[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData7HHH[0x7];                                      // 0x0021(0x0007) MISSED OFFSET
...
struct FStringIdToStringMapping
{
	int                                                Id;                                                        // 0x0000(0x0004) (Const)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (Const, Localized)
	unsigned char                                      bIsWildcard : 1;                                           // 0x000C(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataTZAH[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FLocalizedStringSettingMetaData
{
	int                                                Id;                                                        // 0x0000(0x0004) (Const)
	struct FName                                       Name;                                                      // 0x0004(0x0008) (Const)
	unsigned char                                      UnknownDataPCGN[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
	struct FString                                     ColumnHeaderText;                                          // 0x0010(0x0010) (Const, Localized, NeedCtorLink)
...
struct FAudioComponentParam
{
	...
	unsigned char                                      UnknownDataW4P6[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
struct FOnlineProfileSetting
{
	...
	unsigned char                                      UnknownDataPJKY[0x7];                                      // 0x0001(0x0007) MISSED OFFSET
...
{
	unsigned char                                      bEnabled : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData8VUL[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FQueuedActivationInfo
{
	...
	unsigned char                                      bPushTop : 1;                                              // 0x0028(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJXVB[0x2];                                      // 0x0028(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FPresetGeneratedPoint
{
	...
	unsigned char                                      TangentsValid : 1;                                         // 0x0008(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9HVT[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FOverrideSkill
{
	...
	unsigned char                                      UnknownDataM018[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bCurrentlyPlaying : 1;                                     // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataH006[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct AInterpActor_FCheckpointRecord
{
	...
	unsigned char                                      UnknownDataBOD2[0x3];                                      // 0x0019(0x0003) MISSED OFFSET
	unsigned char                                      bHidden : 1;                                               // 0x001C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData31X0[0x2];                                      // 0x0019(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsShutdown : 1;                                           // 0x001C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataRMTG[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bNeedsPositionReplication : 1;                             // 0x001C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData124H[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBulletBodyData
{
	...
	unsigned char                                      UnknownData1ZBX[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FCurveEdEntry
{
	...
	unsigned char                                      UnknownDataAEV2[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
{
	int                                                Id;                                                        // 0x0000(0x0004) (Const)
	unsigned char                                      UnknownData9M87[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FURL
{
	...
	unsigned char                                      UnknownDataMHBH[0x4];                                      // 0x0024(0x0004) MISSED OFFSET
...
struct FAnimSetBakeAndPruneStatus
{
	...
	unsigned char                                      bReferencedButUnused : 1;                                  // 0x0010(0x0001) BIT_FIELD (Edit, EditConst)
	unsigned char                                      UnknownDataT2OR[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSkipBakeAndPrune : 1;                                     // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataXQIX[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSkipCooking : 1;                                          // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataEEXX[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSplineSoundSlot
{
	...
	unsigned char                                      UnknownData7YSF[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bReplicated : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataFH9B[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHidden : 1;                                               // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataYMW9[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSavedPosition : 1;                                        // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataS7WI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FOnlineStatsColumn
{
	...
	unsigned char                                      UnknownData133R[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FLevelStreamingStatus
{
	...
	unsigned char                                      bShouldBeLoaded : 1;                                       // 0x0008(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataX7KX[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShouldBeVisible : 1;                                      // 0x0008(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataLTB7[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FLinearDOFSetup
{
	...
	unsigned char                                      UnknownData5KAV[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
...
struct FFullyLoadedPackagesInfo
{
	...
	unsigned char                                      UnknownDataDLBF[0x7];                                      // 0x0001(0x0007) MISSED OFFSET
...
struct FMultiCueSplineSoundSlot
{
	...
	unsigned char                                      bPlaying : 1;                                              // 0x0030(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataP18N[0x2];                                      // 0x0030(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSubTrackGroup
{
	...
	unsigned char                                      bIsCollapsed : 1;                                          // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataBYZZ[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsSelected : 1;                                           // 0x0020(0x0001) BIT_FIELD (Transient)
	unsigned char                                      UnknownDataT77Q[0x2];                                      // 0x0024(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAnimNotifyEvent
{
	...
	unsigned char                                      UnknownData58V3[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FAnimControlTrackKey
{
	...
	unsigned char                                      bLooping : 1;                                              // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData23X4[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bReverse : 1;                                              // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData5BTM[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct ADynamicBlockingVolume_FCheckpointRecord
{
	struct FVector                                     Location;                                                  // 0x0000(0x000C)
	struct FRotator                                    Rotation;                                                  // 0x000C(0x000C)
	unsigned char                                      bCollideActors : 1;                                        // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataS0Z5[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bBlockActors : 1;                                          // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData3JUI[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bNeedsReplication : 1;                                     // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData7YVJ[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FBoolTrackKey
{
	...
	unsigned char                                      Value : 1;                                                 // 0x0004(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData96PI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bDisabled : 1;                                             // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataKF2F[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSkelMaterialSetterDatum
{
	...
	unsigned char                                      UnknownDataQO7M[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	float                                              StartTime;                                                 // 0x0000(0x0004)
	unsigned char                                      UnknownDataZU97[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FSoundClassProperties
{
	...
	unsigned char                                      bApplyEffects : 1;                                         // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataI941[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAlwaysPlay : 1;                                           // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataLZ5L[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsUISound : 1;                                            // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData1L7I[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsMusic : 1;                                              // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8SWC[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bReverb : 1;                                               // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataPJ4D[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCenterChannelOnly : 1;                                    // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataF04O[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bApplyAmbientVolumes : 1;                                  // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataZT23[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bEnabled : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataMRCX[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector                                     Location;                                                  // 0x0004(0x000C)
	TEnumAsByte<EWorldAttractorFalloffType>            FalloffType;                                               // 0x0010(0x0001)
	unsigned char                                      UnknownDataF9NR[0x3];                                      // 0x0011(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bCastShadowAsMasked : 1;                                   // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataXQA8[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataDO3Q : 32;                                      // 0x0018(0x0001)
	unsigned char                                      bOverrideCastShadowAsMasked : 1;                           // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataY0KY[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideEmissiveBoost : 1;                                // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataA0II[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideDiffuseBoost : 1;                                 // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJLL8[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideSpecularBoost : 1;                                // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataNJN9[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideExportResolutionScale : 1;                        // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2387[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOverrideDistanceFieldPenumbraScale : 1;                   // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataZZQ7[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSoundClassAdjuster
{
	...
	unsigned char                                      UnknownData9KTX[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
	...
	unsigned char                                      bApplyToChildren : 1;                                      // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataM5JB[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAnimBlendChild
{
	...
	unsigned char                                      bMirrorSkeleton : 1;                                       // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownData8EV1[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsAdditive : 1;                                           // 0x0018(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVT8B[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FMaterialInput
{
	...
	unsigned char                                      UnknownData3HI7[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataXC50[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FDistanceDatum
{
	...
	unsigned char                                      UnknownDataKHV9[0x4];                                      // 0x0014(0x0004) MISSED OFFSET
...
{
	float                                              Time;                                                      // 0x0000(0x0004)
	unsigned char                                      UnknownDataZR9J[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataTTCN[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bEnableGlow : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataPL33[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FRecogUserData
{
	...
	unsigned char                                      UnknownDataZ5D3[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bClipText : 1;                                             // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData3510[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableShadow : 1;                                         // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataTVW7[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2G0H[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FWeightNodeRule
{
	...
	unsigned char                                      UnknownData4ADC[0x3];                                      // 0x0019(0x0003) MISSED OFFSET
...
struct FEmitterBaseInfo
{
	...
	unsigned char                                      bInheritBaseScale : 1;                                     // 0x0028(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataCV8P[0x2];                                      // 0x0028(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSwitchObjectCase
{
	...
	unsigned char                                      bFallThru : 1;                                             // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataX4DU[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDefaultValue : 1;                                         // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData42FH[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FPerBoneMaskInfo
{
	...
	unsigned char                                      bWeightBasedOnNodeRules : 1;                               // 0x0028(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataP9Y4[0x2];                                      // 0x0028(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDisableForNonLocalHumanPlayers : 1;                       // 0x0028(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataY6DD[0x2];                                      // 0x002C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPendingBlend : 1;                                         // 0x0028(0x0001) BIT_FIELD (Transient)
	unsigned char                                      UnknownData9QH1[0x2];                                      // 0x002C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData08EK[0x4];                                      // 0x002C(0x0004) MISSED OFFSET
...
struct FRecognisableWord
{
	...
	unsigned char                                      UnknownData8FWT[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FSoundTrackKey
{
	...
	unsigned char                                      UnknownDataYKWY[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
struct FLandscapeLayerStruct
{
	...
	unsigned char                                      bSelected : 1;                                             // 0x001C(0x0001) BIT_FIELD (Transient, EditorOnly)
	unsigned char                                      UnknownDataT5KS[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	struct FName                                       BoneName;                                                  // 0x0000(0x0008) (Edit)
	unsigned char                                      UnknownDataQG23[0x8];                                      // 0x0008(0x0008) MISSED OFFSET
...
struct FLandscapeLayerInfo
{
	...
	unsigned char                                      bNoWeightBlend : 1;                                        // 0x000C(0x0001) BIT_FIELD (EditorOnly)
	unsigned char                                      UnknownDataVZ7C[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataK1AD : 32;                                      // 0x0020(0x0001)
	unsigned char                                      bSelected : 1;                                             // 0x0020(0x0001) BIT_FIELD (Transient, EditorOnly)
	unsigned char                                      UnknownDataOJYA[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTriangleSortSettings
{
	...
	unsigned char                                      UnknownData9IXD[0x2];                                      // 0x0002(0x0002) MISSED OFFSET
...
struct FSkeletalMeshLODInfo
{
	...
	TArray<unsigned char>                              bEnableShadowCasting;                                      // 0x0018(0x0010) (Edit, EditFixedSize, NeedCtorLink)
	...
	unsigned char                                      bDisableCompressions : 1;                                  // 0x0048(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataGESV[0x2];                                      // 0x0048(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHasBeenSimplified : 1;                                    // 0x0048(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataHWR2[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UseConstant : 1;                                           // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataZJMF[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct APhysicsVolume_FCheckpointRecord
{
	...
	unsigned char                                      UnknownDataGYSJ[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      UnknownDataTRIK[0x3];                                      // 0x0009(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownData3KJD[0x3];                                      // 0x0015(0x0003) MISSED OFFSET
	float                                              NumOfTrianglesPercentage;                                  // 0x0018(0x0004)
	float                                              WeldingThreshold;                                          // 0x001C(0x0004)
	unsigned char                                      bRecalcNormals : 1;                                        // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownData2BC0[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FRandomAnimInfo
{
	...
	unsigned char                                      UnknownDataR0FV[0x2];                                      // 0x0006(0x0002) MISSED OFFSET
	float                                              BlendInTime;                                               // 0x0008(0x0004) (Edit)
	struct FVector2D                                   PlayRateRange;                                             // 0x000C(0x0008) (Edit)
	unsigned char                                      bStillFrame : 1;                                           // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataCSAQ[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      LoopCount;                                                 // 0x0018(0x0001) (Transient)
	unsigned char                                      UnknownDataB3TF[0x3];                                      // 0x0019(0x0003) MISSED OFFSET
...
struct FParticleSysParam
{
	...
	unsigned char                                      UnknownDataTXHE[0x3];                                      // 0x0009(0x0003) MISSED OFFSET
...
struct FClothSpecialBoneInfo
{
	...
	unsigned char                                      UnknownDataSRWS[0x7];                                      // 0x0009(0x0007) MISSED OFFSET
...
struct FSoftBodySpecialBoneInfo
{
	...
	unsigned char                                      UnknownDataMR8M[0x7];                                      // 0x0009(0x0007) MISSED OFFSET
	TArray<int>                                        AttachedVertexIndices;                                     // 0x0010(0x0010) (Const, NeedCtorLink)
...
struct FGizmoSelectData
{
	...
	unsigned char                                      UnknownDataVJV3[0x50];                                     // 0x0008(0x0050) UNKNOWN PROPERTY: MapProperty Engine.LandscapeGizmoActiveActor.GizmoSelectData.WeightDataMap
...
{
	unsigned char                                      bEnabled : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJYSN[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bOpaque : 1;                                               // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataTIS4[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bTranslucent : 1;                                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataDLPK[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDistortion : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataYF3D[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOneLayerDistortionRelevance : 1;                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGIJR[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bLit : 1;                                                  // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVT3B[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUsesSceneColor : 1;                                       // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData1LVT[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSynchGroup
{
	...
	unsigned char                                      bFireSlaveNotifies : 1;                                    // 0x0020(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataFRJ1[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	int                                                MaterialIndex;                                             // 0x0000(0x0004) (Edit)
	unsigned char                                      UnknownData8A26[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	class UMaterialInterface*                          TheMaterial;                                               // 0x0008(0x0008) (Edit)
...
struct FLocalizedSubtitle
{
	...
	unsigned char                                      bMature : 1;                                               // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataC20K[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bManualWordWrap : 1;                                       // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataI8P4[0x2];                                      // 0x0024(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSingleLine : 1;                                           // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataV7TL[0x2];                                      // 0x0024(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UsePSysCompLocation : 1;                                   // 0x0034(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataPOSN[0x2];                                      // 0x0034(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector                                     Normal;                                                    // 0x0038(0x000C)
...
struct FTerrainLayer
{
	...
	unsigned char                                      Highlighted : 1;                                           // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataJBLL[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      WireframeHighlighted : 1;                                  // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataI8GF[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      Hidden : 1;                                                // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataRPUA[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FTerrainDecoration
{
	...
	unsigned char                                      UnknownDataYD1C[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bDebugMode : 1;                                            // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNOGR[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bStatsEnabled : 1;                                         // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataFQNU[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bGatherBSPSurfacesAcrossComponents : 1;                    // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataAYEN[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              CoplanarTolerance;                                         // 0x0004(0x0004) (Edit)
	unsigned char                                      UnknownDataV6BM : 32;                                      // 0x0008(0x0001)
	unsigned char                                      bUseDeterministicLighting : 1;                             // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataU3A2[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUseImmediateImport : 1;                                   // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataU5OQ[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bImmediateProcessMappings : 1;                             // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataHXFO[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bSortMappings : 1;                                         // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataRHJ1[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDumpBinaryFiles : 1;                                      // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataY5EW[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDebugMaterials : 1;                                       // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData1KDI[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bPadMappings : 1;                                          // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataRS5A[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bDebugPaddings : 1;                                        // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataMKRZ[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bOnlyCalcDebugTexelMappings : 1;                           // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNN6K[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUseRandomColors : 1;                                      // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataW9S2[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bColorBordersGreen : 1;                                    // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataOMZ0[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bColorByExecutionTime : 1;                                 // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData02LC[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              ExecutionTimeDivisor;                                      // 0x000C(0x0004) (Edit)
	unsigned char                                      UnknownDataGQ6B : 32;                                      // 0x0010(0x0001)
	unsigned char                                      bInitialized : 1;                                          // 0x0010(0x0001) BIT_FIELD
	unsigned char                                      UnknownData90OL[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bDistributionEnabled : 1;                                  // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataS2GB[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bForceContentExport : 1;                                   // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataT5CQ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bInitialized : 1;                                          // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJ8AH[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FLensFlareElement
{
	...
	unsigned char                                      bIsEnabled : 1;                                            // 0x000C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNSW3[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bUseSourceDistance : 1;                                    // 0x000C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataFEQR[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bNormalizeRadialDistance : 1;                              // 0x000C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataUDQ1[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bModulateColorBySource : 1;                                // 0x000C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataPBKE[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector                                     Size;                                                      // 0x0010(0x000C) (Edit)
	unsigned char                                      UnknownData2EIR[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownDataH4DI : 32;                                      // 0x00D0(0x0001)
	unsigned char                                      bOrientTowardsSource : 1;                                  // 0x00D0(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataXHOY[0x2];                                      // 0x00D0(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData3X4J[0x4];                                      // 0x00D4(0x0004) MISSED OFFSET
...
struct FGameTypePrefix
{
	...
	unsigned char                                      bUsesCommonPackage : 1;                                    // 0x0010(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataUQ8I[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataKFVK[0x4];                                      // 0x0014(0x0004) MISSED OFFSET
...
struct FClientAdjustment
{
	...
	unsigned char                                      UnknownData112L[0x3];                                      // 0x0005(0x0003) MISSED OFFSET
...
{
	unsigned char                                      UnknownDataDKZL[0x8];                                      // 0x0000(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.TerrainComponent.TerrainMaterialMask.BitMask
...
struct FConnectedPeerInfo
{
	...
	unsigned char                                      UnknownDataT9CQ[0x3];                                      // 0x0039(0x0003) MISSED OFFSET
	unsigned char                                      bLostConnectionToHost : 1;                                 // 0x003C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6YQY[0x2];                                      // 0x0039(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FInputEntry
{
	...
	unsigned char                                      UnknownDataANUF[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
...
struct FFilterLimit
{
	unsigned char                                      Enabled : 1;                                               // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataN1UB[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FInputMatchRequest
{
	...
	unsigned char                                      UnknownDataNKNH[0xC];                                      // 0x0020(0x000C) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UseNoise : 1;                                              // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataJZO5[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FAuthSession : public FBaseAuthSession
{
	...
	unsigned char                                      UnknownDataGH27[0x3];                                      // 0x0051(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bEnabled : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData21UZ[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FFontImportOptionsData
{
	...
	unsigned char                                      bEnableAntialiasing : 1;                                   // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData4ZR4[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableBold : 1;                                           // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataXMI9[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableItalic : 1;                                         // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData3YSM[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bEnableUnderline : 1;                                      // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataLT29[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAlphaOnly : 1;                                            // 0x0014(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNYCZ[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EFontImportCharacterSet>               CharacterSet;                                              // 0x0018(0x0001) (Edit)
	unsigned char                                      UnknownDataBKPQ[0x7];                                      // 0x0019(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownDataU54U : 32;                                      // 0x0060(0x0001)
	unsigned char                                      bCreatePrintableOnly : 1;                                  // 0x0060(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData2EMS[0x2];                                      // 0x0060(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIncludeASCIIRange : 1;                                    // 0x0060(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData8RCX[0x2];                                      // 0x0064(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FLinearColor                                ForegroundColor;                                           // 0x0064(0x0010) (Edit)
	unsigned char                                      UnknownDataLTIJ : 32;                                      // 0x0074(0x0001)
	unsigned char                                      bEnableDropShadow : 1;                                     // 0x0074(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataRUXJ[0x2];                                      // 0x0074(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataVQMM : 32;                                      // 0x0098(0x0001)
	unsigned char                                      bEnableLegacyMode : 1;                                     // 0x0098(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataPBQW[0x2];                                      // 0x0098(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                Kerning;                                                   // 0x009C(0x0004) (Edit)
	unsigned char                                      UnknownData9DFU : 32;                                      // 0x00A0(0x0001)
	unsigned char                                      bUseDistanceFieldAlpha : 1;                                // 0x00A0(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataJBK2[0x2];                                      // 0x00A0(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FFontCharacter
{
	...
	unsigned char                                      UnknownDataTK8Y[0x3];                                      // 0x0011(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bCollideActors : 1;                                        // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVJDD[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      ACCUMULATE_DAMAGE : 1;                                     // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataA7T9[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      ASSET_DEFINED_SUPPORT : 1;                                 // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDGFS[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      WORLD_SUPPORT : 1;                                         // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataUI46[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      DEBRIS_TIMEOUT : 1;                                        // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDHPZ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      DEBRIS_MAX_SEPARATION : 1;                                 // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataC9BH[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      CRUMBLE_SMALLEST_CHUNKS : 1;                               // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataV3NR[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      ACCURATE_RAYCASTS : 1;                                     // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataKP2L[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      USE_VALID_BOUNDS : 1;                                      // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataDH15[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      FORM_EXTENDED_STRUCTURES : 1;                              // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataHUAY[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      TAKE_IMPACT_DAMAGE : 1;                                    // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataJN7N[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      IGNORE_POSE_UPDATES : 1;                                   // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataFPEN[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      IGNORE_RAYCAST_CALLBACKS : 1;                              // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataPG99[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      IGNORE_CONTACT_CALLBACKS : 1;                              // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataKU47[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      USER_FLAG_1 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataL56H[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      USER_FLAG_2 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataUCZX[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      USER_FLAG_3 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataO4PM[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      USER_FLAG_4 : 1;                                           // 0x0000(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataQ8ZT[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FNxDestructibleParameters
{
	...
	unsigned char                                      bFormExtendedStructures : 1;                               // 0x0078(0x0001) BIT_FIELD (Deprecated)
	unsigned char                                      UnknownDataEF4X[0x2];                                      // 0x0078(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData20SU : 32;                                      // 0x00E4(0x0001)
	unsigned char                                      UseDynamicChunksGroupsMask : 1;                            // 0x00E4(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData9WHV[0x2];                                      // 0x00E4(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<ERBCollisionChannel>                   DynamicChunksChannel;                                      // 0x00E8(0x0001) (Edit, Const)
	unsigned char                                      UnknownData36AW[0x3];                                      // 0x00E9(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bShouldBeLoaded : 1;                                       // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataON6O[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShouldBeVisible : 1;                                      // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataXIA2[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShouldBlockOnLoad : 1;                                    // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataZ1F7[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataDWWA[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FDamageParameters
{
	...
	unsigned char                                      UnknownDataAROH[0x3];                                      // 0x0001(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bIsLocal : 1;                                              // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVURN[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownData9GVM[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	struct FString                                     MessageBody;                                               // 0x0008(0x0010) (NeedCtorLink)
	int                                                BadgeNumber;                                               // 0x0018(0x0004)
	unsigned char                                      UnknownDataR3WR[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bWasLaunchedViaNotification : 1;                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataUSQV[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataVSC7[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FFragmentGroup
{
	...
	unsigned char                                      bGroupIsRooted : 1;                                        // 0x0010(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataXUJU[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FNavMeshPathGoalEvaluatorCacheDatum
{
	...
	unsigned char                                      UnknownDataJ6L2[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	int                                                ListIdx;                                                   // 0x0000(0x0004)
	unsigned char                                      UnknownDataZ1MN[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bIsShutdown : 1;                                           // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataY8K4[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataCFX5[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FPlayerStorageArrayProvider
{
	...
	unsigned char                                      UnknownData4WK4[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FPostProcessSettingsOverride
{
	...
	unsigned char                                      bBlendingIn : 1;                                           // 0x0168(0x0001) BIT_FIELD
	unsigned char                                      UnknownData387M[0x2];                                      // 0x0168(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bBlendingOut : 1;                                          // 0x0168(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataWKM0[0x2];                                      // 0x016C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FDeferredPartToSpawn
{
	...
	unsigned char                                      bExplosion : 1;                                            // 0x0020(0x0001) BIT_FIELD
	unsigned char                                      UnknownData0AX6[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FExpressionInput
{
	class UMaterialExpression*                         Expression;                                                // 0x0000(0x0008)
	int                                                OutputIndex;                                               // 0x0008(0x0004)
	unsigned char                                      UnknownDataZ40I[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
	struct FString                                     InputName;                                                 // 0x0010(0x0010) (NeedCtorLink)
	int                                                Mask;                                                      // 0x0020(0x0004)
	int                                                MaskR;                                                     // 0x0024(0x0004)
	int                                                MaskG;                                                     // 0x0028(0x0004)
...
struct FLayerBlendInput
{
	...
	unsigned char                                      UnknownDataREFR[0x7];                                      // 0x0009(0x0007) MISSED OFFSET
	...
	unsigned char                                      UnknownData4V6D[0x4];                                      // 0x0084(0x0004) MISSED OFFSET
...
struct FCameraShakeInstance
{
	...
	unsigned char                                      bBlendingIn : 1;                                           // 0x0014(0x0001) BIT_FIELD
	unsigned char                                      UnknownData845A[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              CurrentBlendInTime;                                        // 0x0018(0x0004)
	unsigned char                                      UnknownData3LW5 : 32;                                      // 0x001C(0x0001)
	unsigned char                                      bBlendingOut : 1;                                          // 0x001C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataMEWD[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownDataXTF6[0x4];                                      // 0x0044(0x0004) MISSED OFFSET
	class UCameraAnimInst*                             AnimInst;                                                  // 0x0048(0x0008)
	TEnumAsByte<ECameraAnimPlaySpace>                  PlaySpace;                                                 // 0x0050(0x0001)
	unsigned char                                      UnknownDataMRVN[0xF];                                      // 0x0051(0x000F) MISSED OFFSET
...
struct FGameResourceDataProvider
{
	struct FName                                       ProviderTag;                                               // 0x0000(0x0008) (Config)
	struct FString                                     ProviderClassName;                                         // 0x0008(0x0010) (Config, NeedCtorLink)
	unsigned char                                      bExpandProviders : 1;                                      // 0x0018(0x0001) BIT_FIELD (Config)
	unsigned char                                      UnknownData1JA4[0x2];                                      // 0x0018(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataJTQ4[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
...
{
	unsigned char                                      TEXTUREGROUP_World : 1;                                    // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataVRYC[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_WorldNormalMap : 1;                           // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataKOBN[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_WorldSpecular : 1;                            // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataAA5H[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Character : 1;                                // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataAFFQ[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_CharacterNormalMap : 1;                       // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataHPPM[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_CharacterSpecular : 1;                        // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataZ1AC[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Weapon : 1;                                   // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData7ZQT[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_WeaponNormalMap : 1;                          // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData8JMX[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_WeaponSpecular : 1;                           // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData9YOI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Vehicle : 1;                                  // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataHH5T[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_VehicleNormalMap : 1;                         // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData4BRN[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_VehicleSpecular : 1;                          // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataNWKV[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Cinematic : 1;                                // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataDUW4[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Effects : 1;                                  // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataDEE3[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_EffectsNotFiltered : 1;                       // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataRVEV[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Skybox : 1;                                   // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData7SO0[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_UI : 1;                                       // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataXIIL[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Lightmap : 1;                                 // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownData07I9[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_RenderTarget : 1;                             // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataU5RX[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_MobileFlattened : 1;                          // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataKWZK[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_ProcBuilding_Face : 1;                        // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataO4PO[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_ProcBuilding_LightMap : 1;                    // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataWST4[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Shadowmap : 1;                                // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataTU0W[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_ColorLookupTable : 1;                         // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataDJWM[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Terrain_Heightmap : 1;                        // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataX0ZF[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Terrain_Weightmap : 1;                        // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataO85G[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_ImageBasedReflection : 1;                     // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataLXKI[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      TEXTUREGROUP_Bokeh : 1;                                    // 0x0000(0x0001) BIT_FIELD (Edit, Const)
	unsigned char                                      UnknownDataXRT4[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FParameterValueOverTime
{
	...
	unsigned char                                      bLoop : 1;                                                 // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData098T[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAutoActivate : 1;                                         // 0x001C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataR97L[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              CycleTime;                                                 // 0x0020(0x0004) (Edit)
	unsigned char                                      UnknownData72C3 : 32;                                      // 0x0024(0x0001)
	unsigned char                                      bNormalizeTime : 1;                                        // 0x0024(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData5E7M[0x2];                                      // 0x0024(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              OffsetTime;                                                // 0x0028(0x0004) (Edit)
	unsigned char                                      UnknownDataGZEK : 32;                                      // 0x002C(0x0001)
	unsigned char                                      bOffsetFromEnd : 1;                                        // 0x002C(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownData6XI0[0x2];                                      // 0x002C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FScalarParameterValueOverTime : public FParameterValueOverTime
{
	...
	unsigned char                                      UnknownDataC9DF[0x4];                                      // 0x0034(0x0004) MISSED OFFSET
...
struct FMobileDistanceFieldParams
{
	...
	unsigned char                                      EnableShadow : 1;                                          // 0x000C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataYN2G[0x2];                                      // 0x000C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FUIInputKeyData
{
	...
	unsigned char                                      UnknownDataGW6K[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
{
	int                                                SlotIndex;                                                 // 0x0000(0x0004)
	unsigned char                                      UnknownDataWUQA[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	struct FScriptDelegate                             Callback;                                                  // 0x0008(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownDataGZAZ[0xC];                                      // 0x0004(0x000C) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	int                                                SlotIndex;                                                 // 0x0000(0x0004)
	unsigned char                                      UnknownDataVFRF[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	struct FScriptDelegate                             Callback;                                                  // 0x0008(0x000C) (NeedCtorLink)
	unsigned char                                      UnknownData8Q9P[0xC];                                      // 0x0004(0x000C) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FDebugTextInfo
{
	...
	unsigned char                                      bAbsoluteLocation : 1;                                     // 0x003C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataN1HW[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bKeepAttachedToActor : 1;                                  // 0x003C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData3MWC[0x2];                                      // 0x0040(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FVector                                     OrigActorLocation;                                         // 0x0040(0x000C)
	unsigned char                                      UnknownDataH5W5[0x4];                                      // 0x004C(0x0004) MISSED OFFSET
...
struct FUIRangeData
{
	...
	unsigned char                                      bIntRange : 1;                                             // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataEZQM[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FInputKeyAction
{
	...
	unsigned char                                      UnknownDataKLQ2[0x7];                                      // 0x0009(0x0007) MISSED OFFSET
...
struct FInputEventParameters
{
	...
	unsigned char                                      UnknownDataCV9W[0x3];                                      // 0x0011(0x0003) MISSED OFFSET
	float                                              InputDelta;                                                // 0x0014(0x0004) (Const, Transient, AlwaysInit)
	float                                              DeltaTime;                                                 // 0x0018(0x0004) (Const, Transient, AlwaysInit)
	unsigned char                                      bAltPressed : 1;                                           // 0x001C(0x0001) BIT_FIELD (Const, Transient, AlwaysInit)
	unsigned char                                      UnknownData5UEY[0x2];                                      // 0x001C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCtrlPressed : 1;                                          // 0x001C(0x0001) BIT_FIELD (Const, Transient, AlwaysInit)
	unsigned char                                      UnknownDataL40N[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bShiftPressed : 1;                                         // 0x001C(0x0001) BIT_FIELD (Const, Transient, AlwaysInit)
	unsigned char                                      UnknownDataRX16[0x2];                                      // 0x0020(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FUIAxisEmulationDefinition
{
	...
	unsigned char                                      bEmulateButtonPress : 1;                                   // 0x0010(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataL37M[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bEnabled : 1;                                              // 0x0010(0x0001) BIT_FIELD (AlwaysInit)
	unsigned char                                      UnknownData025K[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	TArray<unsigned char>                              HiddenMaterials;                                           // 0x0000(0x0010) (Const, NeedCtorLink)
	unsigned char                                      bNeedsInstanceWeightUpdate : 1;                            // 0x0010(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataR4YW[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bAlwaysUseInstanceWeights : 1;                             // 0x0010(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownData3JSV[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EInstanceWeightUsage>                  InstanceWeightUsage;                                       // 0x0014(0x0001) (Const, Transient)
	unsigned char                                      UnknownData8W1W[0x3];                                      // 0x0015(0x0003) MISSED OFFSET
...
{
	unsigned char                                      bClearColorTargetEveryFrame : 1;                           // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataO1X3[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	struct FColor                                      ColorTargetClearColor;                                     // 0x0004(0x0004) (Edit)
	unsigned char                                      UnknownDataW8OI : 32;                                      // 0x0008(0x0001)
	unsigned char                                      bClearDataTargetEveryFrame : 1;                            // 0x0008(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataNXWS[0x2];                                      // 0x0008(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      bDrawColorDecal : 1;                                       // 0x0000(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataMTA1[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              ColorTextureScale;                                         // 0x0004(0x0004) (Edit)
	class UTexture2D*                                  ColorTexture;                                              // 0x0008(0x0008) (Edit)
	unsigned char                                      UnknownDataYQGY : 32;                                      // 0x0010(0x0001)
	unsigned char                                      bDrawDataDecal : 1;                                        // 0x0010(0x0001) BIT_FIELD (Edit)
	unsigned char                                      UnknownDataOK46[0x2];                                      // 0x0010(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownData7QUG[0x10];                                     // 0x0000(0x0010) MISSED OFFSET
	unsigned char                                      bEnableCollision : 1;                                      // 0x0010(0x0001) BIT_FIELD (Edit, Native)
	unsigned char                                      UnknownData2Z7S[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataAFDQ : 32;                                      // 0x0008(0x0001)
	unsigned char                                      bEnableShadowCasting : 1;                                  // 0x0008(0x0001) BIT_FIELD (Edit, Native)
	unsigned char                                      UnknownDataOE5L[0x2];                                      // 0x0014(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	class UMaterialInterface*                          Material;                                                  // 0x0000(0x0008) (Edit)
	unsigned char                                      UnknownData7DS8[0x10];                                     // 0x0008(0x0010) MISSED OFFSET
...
{
	struct FVector                                     Position;                                                  // 0x0000(0x000C)
	unsigned char                                      UnknownData68GQ[0x4];                                      // 0x000C(0x0004) MISSED OFFSET
...
struct FOnlineFriendMessage
{
	...
	unsigned char                                      bIsFriendInvite : 1;                                       // 0x0048(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataJ9YR[0x2];                                      // 0x0048(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsGameInvite : 1;                                         // 0x0048(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataGRT4[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bWasAccepted : 1;                                          // 0x0048(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataE09P[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bWasDenied : 1;                                            // 0x0048(0x0001) BIT_FIELD
	unsigned char                                      UnknownData3VHI[0x2];                                      // 0x004C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataKKLS[0x4];                                      // 0x004C(0x0004) MISSED OFFSET
...
{
	struct FUniqueNetId                                PlayerID;                                                  // 0x0000(0x0038)
	unsigned char                                      UnknownDataEF2D[0x8];                                      // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlineFriend.SessionId
	...
	unsigned char                                      UnknownDataPXW3[0x3];                                      // 0x0061(0x0003) MISSED OFFSET
	unsigned char                                      bIsOnline : 1;                                             // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataPA7W[0x2];                                      // 0x0061(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsPlaying : 1;                                            // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownData5M93[0x2];                                      // 0x0068(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsPlayingThisGame : 1;                                    // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9J7F[0x2];                                      // 0x0068(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsJoinable : 1;                                           // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6TBV[0x2];                                      // 0x0068(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHasVoiceSupport : 1;                                      // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataQ7QU[0x2];                                      // 0x0068(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHaveInvited : 1;                                          // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataMEDW[0x2];                                      // 0x0068(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHasInvitedYou : 1;                                        // 0x0064(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataLHMA[0x2];                                      // 0x0068(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	int                                                GroupId;                                                   // 0x0068(0x0004) (Const)
	unsigned char                                      UnknownDataZQPQ[0x4];                                      // 0x006C(0x0004) MISSED OFFSET
...
struct FOnlinePartyMember
{
	...
	unsigned char                                      UnknownDataXVN7[0x2];                                      // 0x004A(0x0002) MISSED OFFSET
	int                                                TitleId;                                                   // 0x004C(0x0004) (Const)
	unsigned char                                      bIsLocal : 1;                                              // 0x0050(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataLSSK[0x2];                                      // 0x0050(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsInPartyVoice : 1;                                       // 0x0050(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataZSUV[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsTalking : 1;                                            // 0x0050(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataEGWS[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsInGameSession : 1;                                      // 0x0050(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataHCQL[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsPlayingThisGame : 1;                                    // 0x0050(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownData7LKX[0x2];                                      // 0x0054(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      UnknownDataA8DT[0x4];                                      // 0x0054(0x0004) MISSED OFFSET
	unsigned char                                      UnknownData4QC0[0x8];                                      // 0x0054(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.OnlinePartyMember.SessionId
...
struct FAchievementMediaAsset
{
	...
	unsigned char                                      UnknownDataV363[0x7];                                      // 0x0011(0x0007) MISSED OFFSET
...
{
	int                                                Id;                                                        // 0x0000(0x0004) (Const)
	unsigned char                                      UnknownDataX16T[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	...
	unsigned char                                      bIsSecret : 1;                                             // 0x0058(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownData36JB[0x2];                                      // 0x0058(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bWasAchievedOnline : 1;                                    // 0x0058(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataZY5M[0x2];                                      // 0x005C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bWasAchievedOffline : 1;                                   // 0x0058(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataK07N[0x2];                                      // 0x005C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EAchievementUnlockType>                UnlockType;                                                // 0x005C(0x0001) (Const)
	unsigned char                                      UnknownDataO9QJ[0x3];                                      // 0x005D(0x0003) MISSED OFFSET
	unsigned char                                      UnknownDataQ4B5[0x8];                                      // 0x005D(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.AchievementDetails.ChallengeWindowBegin
	unsigned char                                      UnknownDataI18X[0x8];                                      // 0x0068(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.AchievementDetails.ChallengeWindowEnd
	struct FString                                     DeepLink;                                                  // 0x0070(0x0010) (Const, NeedCtorLink)
	unsigned char                                      UnknownData2VZD[0x8];                                      // 0x0080(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.AchievementDetails.EstimatedUnlockTime
	unsigned char                                      UnknownDataORAI : 32;                                      // 0x0088(0x0001)
	unsigned char                                      bIsRevoked : 1;                                            // 0x0088(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataBUZ7[0x2];                                      // 0x0088(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	TEnumAsByte<EAchievementParticipationType>         ParticipationType;                                         // 0x008C(0x0001) (Const)
	unsigned char                                      UnknownDataGAA5[0x3];                                      // 0x008D(0x0003) MISSED OFFSET
	...
	unsigned char                                      UnknownDataNWU3[0x7];                                      // 0x00A1(0x0007) MISSED OFFSET
...
struct FPlayerResponseLine
{
	...
	unsigned char                                      UnknownDataV0JS[0x4];                                      // 0x0024(0x0004) MISSED OFFSET
...
struct FServerResponseLine
{
	...
	unsigned char                                      UnknownDataD04Q[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData6UX6[0x4];                                      // 0x005C(0x0004) MISSED OFFSET
...
struct FOnlineProfile
{
	...
	unsigned char                                      UnknownDataGKJ2[0x3];                                      // 0x0011(0x0003) MISSED OFFSET
...
struct FFriendsQuery
{
	...
	unsigned char                                      bIsFriend : 1;                                             // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownData6LOK[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	unsigned char                                      UnknownDataFT20[0x8];                                      // 0x0000(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.DownloadedWorkshopData.ItemID
...
struct FCommunityContentFile
{
	...
	unsigned char                                      UnknownData2KHD[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownData20G0[0x4];                                      // 0x0024(0x0004) MISSED OFFSET
...
struct FCommunityContentMetadata
{
	...
	unsigned char                                      UnknownData7G02[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bIsUserGeneratedImage : 1;                                 // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData9UDV[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsGameGeneratedImage : 1;                                 // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataI8ED[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsAchievementImage : 1;                                   // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownData3DN8[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsMediaImage : 1;                                         // 0x0000(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataNRIU[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSocialPostImageInfo
{
	...
	unsigned char                                      UnknownData2C8C[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
{
	unsigned char                                      bCanPostImage : 1;                                         // 0x0000(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownData8SZ3[0x2];                                      // 0x0000(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bCanPostLink : 1;                                          // 0x0000(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataT1XF[0x2];                                      // 0x0004(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FSpeechRecognizedWord
{
	...
	unsigned char                                      UnknownDataN699[0x4];                                      // 0x0004(0x0004) MISSED OFFSET
...
struct FMarketplaceInventoryItem
{
	...
	unsigned char                                      UnknownDataUQ2L[0x2];                                      // 0x0012(0x0002) MISSED OFFSET
	int                                                ConsumableBalance;                                         // 0x0014(0x0004) (Const)
	int                                                TitleId;                                                   // 0x0018(0x0004) (Const)
	unsigned char                                      UnknownDataI3CH[0x4];                                      // 0x001C(0x0004) MISSED OFFSET
	TArray<struct FString>                             ContainerIds;                                              // 0x0020(0x0010) (Const, NeedCtorLink)
	unsigned char                                      UnknownDataPY6Z[0x8];                                      // 0x0030(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceInventoryItem.StartDate
	unsigned char                                      UnknownData6J0L[0x8];                                      // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceInventoryItem.EndDate
	unsigned char                                      UnknownDataSW84[0x8];                                      // 0x0040(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceInventoryItem.RightsObtainedDate
...
struct FMarketplaceProductAvailability
{
	...
	unsigned char                                      bIsPurchasable : 1;                                        // 0x0070(0x0001) BIT_FIELD (Const)
	unsigned char                                      UnknownDataIY4R[0x2];                                      // 0x0070(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	float                                              ListPrice;                                                 // 0x0074(0x0004) (Const)
	float                                              Price;                                                     // 0x0078(0x0004) (Const)
	unsigned char                                      UnknownData5JCQ[0x4];                                      // 0x007C(0x0004) MISSED OFFSET
...
struct FMarketplaceProductDetails
{
	...
	TEnumAsByte<EMediaItemType>                        MediaItemType;                                             // 0x0010(0x0001) (Const)
	unsigned char                                      UnknownDataL907[0x7];                                      // 0x0011(0x0007) MISSED OFFSET
	struct FString                                     ProductName;                                               // 0x0018(0x0010) (Const, NeedCtorLink)
	struct FString                                     ProductID;                                                 // 0x0028(0x0010) (Const, NeedCtorLink)
	unsigned char                                      UnknownDataDON6[0x8];                                      // 0x0038(0x0008) UNKNOWN PROPERTY: QWordProperty Engine.OnlineSubsystem.MarketplaceProductDetails.ReleaseDate
	struct FString                                     SandboxId;                                                 // 0x0040(0x0010) (Const, NeedCtorLink)
	int                                                TitleId;                                                   // 0x0050(0x0004) (Const)
	unsigned char                                      UnknownDataY6L8[0x4];                                      // 0x0054(0x0004) MISSED OFFSET
	...
	unsigned char                                      UnknownDataA1XJ[0x7];                                      // 0x0069(0x0007) MISSED OFFSET
...
struct FWordFilterResult
{
	...
	unsigned char                                      UnknownDataV96K[0x7];                                      // 0x0001(0x0007) MISSED OFFSET
...
struct FTitleFile
{
	...
	unsigned char                                      UnknownDataALW0[0x7];                                      // 0x0011(0x0007) MISSED OFFSET
...
struct FRemoteTalker
{
	...
	unsigned char                                      bWasTalking : 1;                                           // 0x003C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData8E16[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsTalking : 1;                                            // 0x003C(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataVLP8[0x2];                                      // 0x0040(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsRegistered : 1;                                         // 0x003C(0x0001) BIT_FIELD
	unsigned char                                      UnknownData1W6Q[0x2];                                      // 0x0040(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	struct FUniqueNetId                                TalkerId;                                                  // 0x0000(0x0038)
	unsigned char                                      bHasVoice : 1;                                             // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownData79WS[0x2];                                      // 0x0038(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bHasNetworkedVoice : 1;                                    // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownData54WV[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsRecognizingSpeech : 1;                                  // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataK94Q[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bWasTalking : 1;                                           // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataAV56[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsTalking : 1;                                            // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataM2Q9[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	unsigned char                                      bIsRegistered : 1;                                         // 0x0038(0x0001) BIT_FIELD
	unsigned char                                      UnknownDataM988[0x2];                                      // 0x003C(0x0002) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
